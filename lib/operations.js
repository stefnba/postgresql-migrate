...
class Migration {
    ...
    run(direction = 'up', steps = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const appliedMigrationFiles = yield this.listAppliedMigrations();
            ...
            return this.dbQuery
                ...
                if (appliedMigrationFiles.length > 0 && direction === 'up') {
                    console.log(chalk_1.default.blue(`Current migration contains ${appliedMigrationFiles.length} files.\n`));
                }
                if (appliedMigrations.length === 0) {
                    console.log(chalk_1.default.white.bgYellow.bold(`No new migrations files applied [${direction.toUpperCase()}]`));
                }
                if (appliedMigrations.length > 0) {
